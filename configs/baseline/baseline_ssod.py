...
if dataset_name == 'voc':
    ...
    ann_file_val = data_root + f'annotations_json/voc07_test.json'
    ...
    ann_file_val = data_root + f'annotations/instances_val2017.json'
    img_prefix = data_root + 'train2017/'
    img_prefix_val = data_root + 'val2017/'
    num_classes = 80
else:
